...
//
//   const ISBNSearchesWrapper = (input: string) => {
//     setISBNSearches(input);
//   };
...
//               "Inventory Count",
//             ]}
//             ISBNQueries={ISBNSearches.replace(/ /g, "").split(",")}
//           ></TableView>
//           {}
//         </div>
//       ) : (
//         <>
//           <InputBar
//             setSearchComplete={searchCompleteWrapper}
//             setISBNSearchesUpper={ISBNSearchesWrapper}
//           />
//           <div className="flex h-screen w-screen items-center justify-center text-4xl text-white">
//             Please Search for ISBNs to View Book Information
//           </div>
//         </>
//       )}
//     </>
