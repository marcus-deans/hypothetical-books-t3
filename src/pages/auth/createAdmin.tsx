    ...
    return (
        <div className="inline-block p-6 space-y-4 md:space-y-6 sm:p-8 w-3/12">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
                ...
                <button onClick={handleSubmit} type="submit" className="bg-gray-900 w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create admin Account</button>
            </form>
        </div>
    );
}