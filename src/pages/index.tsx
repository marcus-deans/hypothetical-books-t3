      ...
      <div className="py-20">
        <div className="container mx-auto px-6">
          ...
          {!auth && !exist.error && "Login" ? <button
            className="rounded bg-blue-500 py-2 px-4 font-bold text-white hover:bg-blue-700" id="loginButton" onClick={() => {
              void signIn();
            }}>
            Login
          </button> : null}
          {auth && "LogOut" ? <button className="rounded bg-blue-500 py-2 px-4 font-bold text-white hover:bg-blue-700"
            onClick={() => {
              void signOut();
            }}
          >
