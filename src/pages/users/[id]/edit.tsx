...
export default function EditUser(
    ...
    const handleEdit = () => {
        if (userDetailsQuery.data.name == "admin") {
            ...
            toast.error("This account cannot have its privileges revoked because it your own account")
            return;
        }
        else {
            setIsEditing(true);
            ...
            try {
                const deleteResult = deleteMutation.mutate({ id: id , admin: !(data.role == "admin")});
                setTimeout(() => {
